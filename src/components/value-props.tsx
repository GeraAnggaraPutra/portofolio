...
import { ArrowRight, Boxes, GitMerge, LineChart, Users } from "lucide-react";
import { valueProps } from "@/data/portfolio";
import { SectionHeader } from "./section-header";
import { Stagger, StaggerItem } from "./reveal";

const icons = [Boxes, GitMerge, LineChart, Users];
          ...
          return (
            <StaggerItem key={prop.title}>
              ...
              >
                ...
                <div className="mb-4 grid size-10 place-items-center rounded-xl border border-amber-500/20 bg-amber-950/20 text-amber-400">
                  <Icon size={18} />
                </div>

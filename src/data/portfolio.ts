...
export const projects: Project[] = [
  {
    ...
    bullets: [
      ...
      "Built Master Service and Transaction Service modules supporting employee management, attendance, payroll, approval workflows, and mobile app operations.",
      "Developed payroll and attendance calculation workflows with transactional guarantees to prevent partial updates and maintain data consistency across multi-step business processes.",
      "Implemented idempotent processing patterns for retry-safe backend operations, reducing the risk of duplicate processing in payroll and attendance workflows.",
      "Optimized attendance and payroll processing by applying Redis caching and database denormalization to reduce repeated calls to Master Service and improve response time.",
      "Created a custom API Gateway in Go to manage routing, authentication middleware, request enrichment, correlation IDs, and inter-service communication.",
      "Implemented background workers and scheduled jobs for payroll, attendance, and operational processes, with structured logging for traceability and easier debugging.",
      "Implemented observability using Grafana, Loki, Alloy, and Prometheus, enabling centralized logs, metrics tracking, and faster issue investigation across backend services.",
      "Improved API reliability through database query optimization, transaction handling, Swagger documentation, and reusable backend patterns.",
    ],
  },
  {
    title: "MyNusapala",
